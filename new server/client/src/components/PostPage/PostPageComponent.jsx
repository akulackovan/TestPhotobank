            ...
            {post &&
                <div className='post'>
                    <div className='one'>
                        ...
                        <img className='img' style={{ width: '600px', height: '479px' }} src={`${post.image}`} />
                        <div className='stat'>
                            <div>
